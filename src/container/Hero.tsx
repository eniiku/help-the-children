export const Hero = () => {
  return (
    <section className="table h-[calc(100vh-96px)] text-center text-white px-8">
      <main className="table-cell align-middle">
        ...
        <p className="text-sm opacity-75 leading-[1.7] mb-6">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis vitae,
          phasellus enim elementum. Amet, platea sit etiam accumsan, vel dictum.
        </p>
